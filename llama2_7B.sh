...
CUDA_VISIBLE_DEVICES=$4 python finetune.py \
    --base_model '/data2/yjq/llama2_7B_hf' --method_name 'lora' \
    --data_path 'commonsense_170k.json' \
    --output_dir $3 \
    --batch_size 8  --micro_batch_size 8 --eval_batch_size 2 --num_epochs 3 \
    --learning_rate 2e-4 --cutoff_len 256 --val_set_size 120 \
    --eval_step 6000 --save_step 6000  --adapter_name lora \
...
CUDA_VISIBLE_DEVICES=$4 python commonsense_evaluate.py \
    ...
    --adapter LoRA \
    --dataset boolq \
    --base_model '/data2/yjq/llama2_7B_hf' \
    --batch_size 1 \
